...
class Handcontrol(Node):
    ...
    def hand_control_status(self):
        ...
        '''
        print("can_use_hand: ", self.turtlebot_status_msg.can_use_hand)
        print("can_put: ", self.turtlebot_status_msg.can_put)
        print("can_lift: ",self.turtlebot_status_msg.can_lift)
